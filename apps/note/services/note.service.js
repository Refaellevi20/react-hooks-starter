...
function getById(bookId) {
    return storageService.get(NOTE_KEY, bookId).then(_setNextPrevBookId)
}
...
let books = utilService.loadFromStorage(NOTE_KEY)
if (!books || !books.length) {
    ...
    utilService.saveToStorage(NOTE_KEY, books)
}
}
